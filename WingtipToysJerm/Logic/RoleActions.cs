...
namespace WingtipToysJerm.Logic
{
    internal class RoleActions
    {
        internal void createAdmin()
        {
            ...
            // Create a UserManager object based on the UserStore object and the ApplicationDbContext object. Note that you can create new objects and use them as parameters in 
            // a single line of code, rather than using multiple lines of code, as you did for the RoleManager object.
            ...
            IdUserResult = userManager.Create(appUser, "Pa$$word");
